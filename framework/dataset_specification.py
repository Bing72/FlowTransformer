...
class NamedDatasetSpecifications:
    ...
    cicflowmeterV3 = DatasetSpecification(
        ...
        categorical_fields=['Src Port', 'Dst Port', 'Protocol', 'Fwd PSH Flags', 'Bwd PSH Flags', 'Fwd URG Flags', 'Bwd URG Flags'],
        class_column="Label",
        benign_label="Benign"
    )
